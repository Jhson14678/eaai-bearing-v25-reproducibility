...
Set `SCA_OUTPUT_ROOT` to choose the result directory. The default is native-rate features and elapsed-time splitting. The archive is available at <https://github.com/Jhson14678/eaai-bearing-v25-reproducibility> (release `v31.6` (master commit `7aa2504`)).
